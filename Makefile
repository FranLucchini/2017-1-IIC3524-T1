...
MTH=-lm
# Manejo de imágenes PNG (Portable Network Graphics)
PNG=-lpng
...
DEPS=$(foreach i, $(COMMON), $(wildcard src/$(i)/*.h)) Makefile
...
obj/%.o: src/%.c $$(wildcard src/$$(patsubst obj/%/,%,$(dir $$@)/*.h)) $(DEPS)
